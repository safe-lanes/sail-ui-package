...
export default function FormCheckboxRadio() {
  return (
    <Card className="p-3">
      <h2 className="text-2xl font-semibold text-slate-900 mb-6">Checkboxes & Radio Buttons</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            {/* Toggle style */}
            <Label className="flex items-center gap-3 cursor-pointer">Toggle Switch</Label>
            <Switch />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            {/* Disabled */}
            <Label className="flex items-center gap-2 flex-row-reverse text-gray-400">
              <Input type="radio" name="radioGroupDisabled" className="h-4 w-4" disabled />
              Disabled Radio
            </Label>
            ...
            <div className="flex gap-6">
              <Label className="">
                <Input type="radio" name="inlineRadio" className="h-4 w-4 accent-red-600" />
                Option 1
              </Label>
              <Label className="">
                <Input
