...
export const StandardFormPopup = React.forwardRef<HTMLDivElement, FormPopupProps>(
  ({ className, children, open = true, onOpenChange, title, ...props }, ref) => {
    if (!open) return null;
...
const FormPopupOverlay = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const FormPopupContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
