      ...
      {steps.map((step, index) => {
        ...
        return (
          <div
            ...
            className={clsx(
              'flex relative',
              isVertical ? 'items-start' : 'flex-col items-center flex-1',
            )}
          >
            {/* Step Circle */}
            <div className={clsx('flex items-center', isVertical ? 'flex-col' : '')}>
              <button
                type="button"
                onClick={handleClick}
            ...
            {/* Labels */}
            <div className={clsx(isVertical ? 'ml-4' : 'mt-2 text-center')}>
              <div
                className={clsx(
                  'text-sm font-medium',
